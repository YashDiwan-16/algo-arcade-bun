...
export default function PaajiLeaderboardPage() {
  const { data, isLoading } = useQuery({
    queryKey: ["scoreLeaderboard", "paaji"],
    queryFn: () =>
  ...
  const columns = useMemo<ColumnDef<ScoreLeaderboardEntry>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} label="Best Winnings" />
        ),
        cell: ({ row }) => (
          <div className="flex items-center gap-2">
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} label="Total Winnings" />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} label="Avg Winnings" />
        ),
        cell: ({ row }) => (
          <div className="flex items-center gap-2">
    ...
    <div className="container mx-auto p-4 md:p-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Compete for the highest winnings and top the leaderboard!
        </p>
      </div>
